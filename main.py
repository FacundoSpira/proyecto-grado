...
if __name__ == "__main__":
    value, time, status, variables = solve_model(Case.large, Solver.GUROBI_CMD, 0.5, 0.25, 480)
    ...
    generate_schedule_csv(variables, f"output/schedule_beta:05_alpha:025_{timestamp}.csv")
